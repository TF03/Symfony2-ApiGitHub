...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'git_hub', 'user' => 'root', 'password' => 123, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/GitHub/LikeBundle/Entity'))), 'GitHub\\LikeBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('GitHubLikeBundle' => 'GitHub\\LikeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0e44219da4f9f74aab249d2b680fd50ac53d2659ac4fc7ab3daf1291d61838b3');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GitHub/ApiBundle/Resources/views'), 'GitHubApi');
        $instance->addPath(($this->targetDirs[3].'/src/GitHub/LikeBundle/Resources/views'), 'GitHubLike');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GitHubApiBundle' => 'GitHub\\ApiBundle\\GitHubApiBundle',
                'GitHubLibBundle' => 'GitHub\\LibBundle\\GitHubLibBundle',
                'GitHubLikeBundle' => 'GitHub\\LikeBundle\\GitHubLikeBundle',
